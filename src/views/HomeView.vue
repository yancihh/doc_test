<template>
  <div>
    <div class="boxx">
      <div class="bbb" v-for="(res_root, index_root) in newJsonArr" :key="index_root">
        <div class="ooo">{{ res_root.title }}</div>
        <div class="xxxx" v-for="(res_parent, index) in res_root.value" :key="index">
          <div class="a" v-for="(res_child, index_child) in res_parent" :key="index_child">
            {{ res_child.kpi_name }}
          </div>
        </div>
      </div>
